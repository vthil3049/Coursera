...
function($scope, favoriteFactory, baseURL, $ionicListDelegate, dishes) {
  ...
  .controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'favoriteFactory', 'dish', 'baseURL', '$ionicPopover', '$ionicModal', '$timeout',
  function($scope, $stateParams, menuFactory, favoriteFactory, dish, baseURL, $ionicPopover, $ionicModal, $timeout)
  {
    $scope.baseURL = baseURL;
    $scope.dish = {};
    ...
    $scope.addComment = function() {
      //close the popover that called this comment modal box
      $scope.closePopover();
      $scope.commentForm.show();
    };

    // Perform the comment add action when the user submits the comment form
  ...
  .controller('IndexController', ['$scope',  'baseURL', 'dish', 'leader', 'promotion',
  function($scope,  baseURL, dish, leader, promotion) {
